...
<div class="bg-img">
    <div class="content">
      ...
      <?php
           ...
           $password = $_POST["password"];
            ...
            if ($user) {
                if (password_verify($password, $user["password"])) {
                    session_start();
                    $_SESSION["user"] = "yes";
                    echo '<script>alert("You have Login successfully...");window.location="makeup.php"</script>';
                    die();
                }else{
        ...
        ?>
      <form action="login_make.php" method="POST">
        <div class="field">
      ...
      <div class="signup">Don't have account?
        <a href="register_make.php">Signup Now</a>
      </div>
    </div>
  </div>
