...
<div class="bg-img">
    <div class="content">
      ...
      ?>
      <form action="register_nail.php" method="POST">
      ...
      <br>
      <div>
        <div class="signup" style="font-size: 15px; color: white; font-family: 'Poppins', sans-serif;">
          Already registered ?
          <a href="login_nail.php" style="color: #3498db; text-decoration: none;"> Login here</a>
        </div>
      </div>
    </div>
  </div>
