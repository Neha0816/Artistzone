...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (count($errors) == 0) {
      ...
      if ($user_result->num_rows == 0) {
        ...
        $sql = "SELECT * FROM nail_booking WHERE username='$name' AND email='$email' AND date='$date' AND time='$time'";
        ...
        if ($result->num_rows > 0) {
          ...
          $sql = "INSERT INTO nail_booking (username, email, date, time) VALUES ('$name', '$email', '$date', '$time')";
